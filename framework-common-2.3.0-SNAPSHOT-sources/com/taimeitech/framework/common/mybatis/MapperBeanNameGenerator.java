package com.taimeitech.framework.common.mybatis;

import com.taimeitech.framework.common.annotation.IgnoreTenant;
	...
	public String generateBeanName(BeanDefinition definition, BeanDefinitionRegistry registry) {
		...
		try {
			...
			if (CollectionUtils.isNotEmpty(methods)) {
				methods.stream().filter(m -> m.isAnnotationPresent(IgnoreTenant.class)).forEach(m -> {
