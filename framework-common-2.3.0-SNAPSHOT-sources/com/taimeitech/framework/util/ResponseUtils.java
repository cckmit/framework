...
public class ResponseUtils {
	...
	public static void renderJsonp(final HttpServletResponse response, final String callbackName,
		...
		try {
			...
			jsonParam = mapper.writeValueAsString(contentMap);
	...
	public static void setDownloadFileName(HttpServletRequest req, HttpServletResponse resp, String fileName) throws UnsupportedEncodingException {
